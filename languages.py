hlaseni_en = {
    ...
    "pravidla-top10": "To show shortest 10 attempts type: 'top10'",
    ...
    "konec_bez_cisla": "Thanks for playing! But sorry, I'll not tell you the number.",
    "konec": "Thanks for playing! See you next time.",
...
hlaseni_cz = {
    ...
    "pravidla-top10": "Pro zobrazení nejlepších 10 pokusů zadej: 'top10'",
    ...
    "konec_bez_cisla": "Díky za hru! Ale nečekej, že Ti číslo prozradím ;).",
    "konec": "Díky za hru! Přijď příště.",
    "hodnoceni": "Počet {} a {}",
    "gratulace": "!!! Gratulace !!!",
